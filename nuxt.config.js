export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'og:title', content: 'Tutku Uçan | Software Developer' },
      { name: 'og:image', content: 'https://tutku.space/images/og-image.jpg'},
      { name: 'og:description' , content: 'Tutku Uçan was improve himself about Software Development since 4 years about Web Development, DevOps, Databases and Programming Basics. Now he is professional Software Developer. He worked at eQuota GmbH as Frontend Developer on beginning his career. Now he is Freelancer and developing own Full-Stack Web Projects.'},
      { name: 'og:site_name', content: 'Tutku Uçan | Software Developer' },
